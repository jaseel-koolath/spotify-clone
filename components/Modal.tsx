      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="fixed drop-shadow-md border border-neutral-700 top-[50%] 
            left-[50%] max-h-full h-full md:h-auto md:max-h-[85vh] w-full md:w-[90vw] md:max-w-lg 
        ...
        >
          ...
          <Dialog.Close asChild>
            <button
              className="absolute top-[10px] right-[10px] text-neutral-400
              hover:text-white inline-flex h-[25px] w-[25px] appearance-none 
                focus:outline-none items-center justify-center rounded-full "
            >
              <IoMdClose />
            </button>
          </Dialog.Close>
